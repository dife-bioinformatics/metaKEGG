...
class PipelineAsync:
    ...
    async def single_input_with_miRNA_quantification(self, miRNA_file_path: Union[str, Path] = None, miRNA_pvalue_column: Optional[str] = None, miRNA_pvalue_threshold: Optional[float] = None, miRNA_genes_column: str = None, miRNA_ID_column: Optional[str] = None,
                                               benjamini_threshold: Optional[float] = None, count_threshold: Optional[int] = 2 , pathway_pvalue_threshold: Optional[float] = None):
        """
        Perform Single Input Analysis with miRNA.
